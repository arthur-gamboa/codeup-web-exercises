...
var percP = prompt("Please enter % (in decimals) amount you'd like to tip");
var totalP = prompt("Please enter total of the bill");

alert("Here is the tip amount recommended: $" + calculateTip(percP, totalP));
